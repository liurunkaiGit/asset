...
ALTER TABLE t_lc_station_letter MODIFY content varchar(1000) DEFAULT NULL COMMENT '消息内容';
ALTER TABLE t_lc_station_letter_agent MODIFY content varchar(1000) DEFAULT NULL COMMENT '消息内容';
