...
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `url`, `target`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('查询', (SELECT t.menu_id from sys_menu t where t.menu_name = '呼叫明细查询'), '1', '#', 'menuItem', 'F', '0', 'robot:his:list', '#', 'zhang', '2020-07-21 14:26:13', '', NULL, '');
INSERT INTO `sys_menu` (`menu_name`, `parent_id`, `order_num`, `url`, `target`, `menu_type`, `visible`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES ('查询', (SELECT t.menu_id from sys_menu t where t.menu_name = '呼叫任务查询'), '1', '#', 'menuItem', 'F', '0', 'robot:pandect:his:list', '#', 'admin', '2020-07-21 14:30:51', '', NULL, '');
