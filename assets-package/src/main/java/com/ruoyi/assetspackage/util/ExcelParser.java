...
//          this.columsLength = columsLength;
        ...
        public void cell(String cellReference, String formattedValue, XSSFComment comment) {
            ...
            if(dateValidator(formattedValue)){
                formattedValue = this.dateConvert(formattedValue);
            }
            try {
        ...
        public boolean dateValidator(String param) {
            SimpleDateFormat validator = new SimpleDateFormat("MM/dd/yy");
            validator.setLenient(false);
            try {
                validator.parse(param);
                return true;
            } catch (java.text.ParseException e) {
                return false;
            }
        }
        public String dateConvert(String param) {
            String format = "";
            SimpleDateFormat validator = new SimpleDateFormat("MM/dd/yy");
            ...
            try {
                Date date = validator.parse(param);
                format = convertor.format(date);
            } catch (java.text.ParseException e) {
                e.printStackTrace();
            }
            return format;
