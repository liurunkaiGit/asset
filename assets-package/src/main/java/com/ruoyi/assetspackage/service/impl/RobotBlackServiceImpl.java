...
import com.ruoyi.assetspackage.mapper.RobotBlackMapper;
import com.ruoyi.assetspackage.service.IRobotBlackService;
 ...
 */
@Service
public class RobotBlackServiceImpl implements IRobotBlackService {
    @Autowired
    private RobotBlackMapper tLcRobotBlackMapper;
    ...
    public int insertTLcRobotBlack(Task tLcTask, String reason, String phone) {
        RobotBlack tLcRobotBlack = new RobotBlack();
    ...
    @Override
    public void deleteobotBlackByCaseReason(RobotBlack robotBlack) {
