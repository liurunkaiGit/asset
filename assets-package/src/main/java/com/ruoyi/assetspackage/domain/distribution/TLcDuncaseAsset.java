...
public class TLcDuncaseAsset extends BaseEntity {
...
//    @JsonFormat(pattern = "yyyy-MM-dd")
     ...
     *
     */
    private TLcTaskAsset tLcTask;

    private TLcCustinfoAsset tLcCustinfo;

    private List<TLcDuncaseAssignAsset> tlcDuncaseAssignList;

    private List<TLcCustContactAsset> tlcCustContactList;

    private List<TLcCallRecordAsset> callRecordList;

    private List<TLcDuncaseActionRecordAsset> actionRecordList;
